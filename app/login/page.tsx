      ...
      <main className="w-full max-w-md flex flex-col gap-[2rem] relative z-10 fade-in-up">
        ...
        <header className="text-center flex flex-col items-center gap-4">
          ...
          <p className="text-[16px] leading-6 text-on-surface-variant">
            Accelerate your daily progress.
          </p>
        </header>
        ...
        >
          ...
          <div className="flex flex-col gap-2">
            <label className="text-[14px] font-semibold leading-5 tracking-[0.01em] text-on-surface-variant ml-2" htmlFor="email">
              Email
            </label>
          ...
          <div className="flex flex-col gap-2">
            <div className="flex justify-between items-center ml-2">
              <label className="text-[14px] font-semibold leading-5 tracking-[0.01em] text-on-surface-variant" htmlFor="password">
                Password
              </label>
              <a href="#" className="text-[12px] font-medium text-primary hover:opacity-80 transition-opacity">
                Forgot Password?
              </a>
            </div>
            <div className="relative group">
          ...
          <button
            type="submit"
            disabled={loading}
            className="mt-4 w-full bg-primary text-on-primary text-[20px] font-semibold leading-7 py-4 rounded-xl shadow-[0_10px_25px_rgba(77,142,255,0.4)] hover:shadow-[0_15px_35px_rgba(77,142,255,0.6)] hover:-translate-y-1 active:translate-y-0 transition-all duration-300 relative overflow-hidden group disabled:opacity-60"
          >
          ...
          <div className="grid grid-cols-2 gap-4">
            <button
              ...
              className="bg-surface-container-high hover:bg-surface-bright border border-white/5 py-3 rounded-xl flex items-center justify-center gap-2 transition-colors"
            >
              ...
              <span className="text-[14px] font-semibold text-on-surface">Google</span>
            </button>
            <button
              type="button"
              className="bg-surface-container-high hover:bg-surface-bright border border-white/5 py-3 rounded-xl flex items-center justify-center gap-2 transition-colors"
            >
              ...
              <span className="text-[14px] font-semibold text-on-surface">Apple</span>
            </button>
          </div>
        </form>
        ...
        <div className="text-center">
          <p className="text-[16px] leading-6 text-on-surface-variant">
            ...
            <Link href="/register" className="text-primary text-[20px] font-semibold hover:opacity-80 transition-opacity ml-1">
              Create Account
            </Link>
          </p>
        </div>
